...
#### Shape Node
Object's surface data is stored in this node, such as mesh, nurbs curve & surface, locator, ...  
...
They must have a transformation node as a parent to define where the object is located in space.  
