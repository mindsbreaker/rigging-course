...
!!! To duplicate a joint chain on the opposite side, for example from left to right, use the [**mirror joint tool**](https://help.autodesk.com/view/MAYAUL/2020/ENU/?guid=GUID-CEA7B7ED-10B9-43C7-AD15-8B7E4DC44360) in the rig menu **Skeleton** -> **Mirror Joint**.  
